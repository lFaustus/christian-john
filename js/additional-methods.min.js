...
jQuery.validator.addMethod("phoneAll",function(a,b){a=a.replace(/\s+/g,"");return this.optional(b)||a.length>7&&a.match(/\(?([0-9])\)?([ .-]?)([0-9])\2([0-9])/)},"Please specify a valid phone number");
