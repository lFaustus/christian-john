    ...
    <form class = "form" role = "form">
      ...
      <div class = "col-md-4" style = "margin-top:15px">
        ...
        <div style = "margin-bottom:10px" class = "input-group">
          ...
          <input type = "text" class = "form-control" style = "height:45px" placeholder = "Agency Name"/>
        </div>
        <div style = "margin-bottom:10px" class = "input-group">
          <span class = "input-group-addon" style=" color:#eb477d"><i class = "glyphicon glyphicon-pencil"></i></span>   
          <input type = "text" class = "form-control" style = "height:45px" placeholder = "Agency Branch"/>
        </div>
        ...
        <div style = "margin-bottom:10px" class = "input-group">
          ...
          <input type = "text" class = "form-control" style = "height:45px" placeholder = "Contact Person"/>
        </div>
        
        <div class = "input-group" style = "margin-bottom:10px">
          <span class = "input-group-addon" style=" color:#eb477d"><i class = "glyphicon glyphicon-earphone"></i></span>
          <input type = "text" class = "form-control" style = "height:45px" placeholder = "Contact Person No."/>
        </div>
      </div>
      <div class = "col-md-4" style = "margin-top:15px">
        <div style = "margin-bottom:10px" class = "input-group">
          <span class = "input-group-addon"style=" color:#eb477d"><i class = "glyphicon glyphicon-envelope"></i></span>   
          <input type = "text" class = "form-control" style = "height:45px" placeholder = "Agency Email"/>
        </div>
