...
<tr>
<td>
<a href="updateprocess.php?id=<?php echo $p['aprocessid']; ?>">UPDATE</a>
<a href="deleteprocess.php?id=<?php echo $p['aprocessid']; ?>" onclick = "return confirm('Are You Sure!')">DELETE</a>
</td>
<td><a href="rspage.php?id=<?php echo $p['aprocessid'];?>"><?php echo htmlentities($p['processname']);?></a></td>
