...
<body>
 ...
 <div style="margin-left:30px; margin-right:30px;">
  ...
  <h3 style="padding-top: 30px; "class="panel-title mdi-action-assignment mdi-4x"><h2> Requirements and Steps</h2></h3>
    </div>
...
<div class="well well-lg">
 <a href="listrequirement.php?id=<?php echo $pid; ?>"><h3> Requirements </h3></a>



 <a href="liststeps.php?id=<?php echo $pid; ?>"><h3> Steps </h3></a>
</div>



<a href="agencypage.php" class="btn btn-default btn-fab btn-raised mdi-hardware-keyboard-backspace"></a>
