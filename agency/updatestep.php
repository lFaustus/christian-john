...
<table>
<tr>
<td><label for="steps">Step</label></td>
<td><textarea name="steps" id="requirement" value="<?php if(isset($_POST['steps'])){ echo htmlentities($_POST['steps']);}?>" required ><?php echo htmlentities($step['stepdesc']); ?></textarea></td>
</tr>
<tr>
<td><input type="submit" name="update" value="UPDATE"></td>
<td><a href="liststeps.php?id=<?php echo $pid; ?>">Return to List</a></td>
</tr>
</table>
</form>
