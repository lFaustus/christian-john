...
<!-- <div id="wrapper"> -->
  ...
  <h3 style="padding-top: 30px; "class="panel-title mdi-action-assignment mdi-4x"><h2>Renew Subscription</h2></h3>
    </div>
...
<?php if($plan){?>
<form method="POST" action="paynow.php" target="_blank">
...
<?php }?>
 ...
 <label for="no"><h4> Number of Month(s) / Year(s) </h4></label> 
