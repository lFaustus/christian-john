...
<body>
   ...
   <!-- //END OF TOP NAV BAR -->
    ...
    <div style="padding-bottom: 60px; text-align: center;" class="panel-heading">
        <h3 style="padding-top: 30px; "class="panel-title mdi-communication-contacts mdi-4x"><h2> Active Agencies</h2></h3>
    </div>
...
<?php foreach($ag as $a){?>
             <tr>  
                ...
                <td>
           <a type="button" href="approveagency.php?id=<?php echo $a['agencyid'];?> " style="color: red;" class="mdi-navigation-close mdi-2x" style="background-color:white;"></a>
