<?php
	...
	$paypal_ipn_url = 'http://127.0.0.1/endinmind2/enduser/paypalipn.php';
	...
	$return_link = 'http://127.0.0.1/endinmind2/enduser/paypalipn.php';

	//cancel return - Explanation: If buyer hits "Cancel" button on paypal, he will be redirected to this page
	$cancel_return = 'http://127.0.0.1/endinmind2/enduser/paypalipn.php';
...
<!-- <div id="wrapper"> -->
  ...
  <h3 style="padding-top: 30px; "class="panel-title mdi-action-assignment mdi-4x"><h2>Processing</h2></h3>
    </div>
...
<div id="centered">
  ...
  <p><button class="btn btn-info btn-raised" type="submit">Continue Checkout</button></p>
  <br/><br/>
  <br/><br/>
</div>
</form>
