			   ...
			   <div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="slide-inner">
							...
							<div class="menu">
								<ul>
									<li><a href="javascript:menu(0);"><img class = "img-circle" width="100px" height="45px" src="files/<?php echo $info['image'];  ?>" alt="" title="" /><span>My Profile</span></a></li>
									<li><a href="javascript:menu(1);"><img src="images/icons/light.png" alt="" title="" /><span>My Process</span></a></li>
									<li><a href="javascript:menu(2);"><img src="images/icons/code.png" alt="" title="" /><span>Subscriptioin</span></a></li>
									<li><a href="javascript:menu(3);"><img src="images/icons/docs.png" alt="" title="" /><span>Create Process</span></a></li>
									<li><a href="javascript:menu(4);"><img src="images/icons/docs.png" alt="" title="" /><span>Download Process</span></a></li>
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="slide-inner">
						...
						<h2 class="page_title">My Profile</h2><hr />
						...
						<div class="image_single" ><img class = "img-circle" width="150px" height="120px" src="files/<?php echo $info['image']; ?>" alt="" title="" border="0" /></div>
							<div class="image_caption blue blue_borderbottom">Hope L. Nadela</div>
							<ul class="responsive_table">
								...
								<div class="table_section">Liburon, Carcar City, Cebu</div>
								</li>
								<li class="table_row">
									<div class="table_section">Birthdate: </div>
									<div class="table_section">September 11, 1991</div> 
								</li>
								<li class="table_row">
									<div class="table_section">Email: </div>
									<div class="table_section">cenezoic_n@yahoo.com</div> 
								</li>
								<li class="table_row">
									<div class="table_section">Contact No: </div>
									<div class="table_section">0933144232</div> 
								</li>
							</ul>	
						</div> <hr /><br />		
					<!--	<script type="text/javascript">
