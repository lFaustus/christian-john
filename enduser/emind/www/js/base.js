...
/*function checkMember() {
	...
	//var url = 'http://www.ojtap.com/mobile/member.php'; // 'http://10.0.2.2/mobile/member.php'
	else (user != '' && pass != '') {
		$.ajax({
			type: 'POST',
			url: '../userlogin.php',
...
function goTo() {
	...
	if (user != undefined || user != null || user.length != 0 || pass != undefined || pass != null || pass.length != 0) {
