                ...
                <ul class="nav navbar-nav side-nav">
                    <li class = "active">
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a title = "Personal Process" style = "color:#1ebb90" href="listprocess.php"><i class = "fa fa-fw fa-user"></i> Personal</a>
                            </li>
                            <li>
                                <a title = "Agency Process"style = "color:#1ebb90" href="downloadedprocess.php"><i class = "fa fa-fw fa-building"></i> Agency</a>
                            </li>
                    ...
                    <li>
                       <a href="agenciesprocess.php" class = "btn btn-success" style = "margin-left:20px; margin-top:25px"><b>Download Process</b> </a>
                    </li>
